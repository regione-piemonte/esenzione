...
@JsonPropertyOrder({ "certificato_id", "file_base64", "data_rilascio", "data_fine_validita", "note", "tipologia",
		"tipologia_invalidita", "malattia", "tipologia_documento" })
public class Certificato {
	...
	private TipologiaInvalidita tipologia_invalidita;
	@JsonIgnore
	...
	public TipologiaInvalidita getTipologia_invalidita() {
		return tipologia_invalidita;
	}

	public void setTipologia_invalidita(TipologiaInvalidita tipologia_invalidita) {
		this.tipologia_invalidita = tipologia_invalidita;
	}
