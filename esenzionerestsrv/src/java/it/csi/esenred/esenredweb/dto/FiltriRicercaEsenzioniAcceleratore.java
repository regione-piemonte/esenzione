...
public class FiltriRicercaEsenzioniAcceleratore {
	...
	private Filtri protocollo;
	private Filtri attestato;
	...
	public Filtri getProtocollo() {
		return protocollo;
	}
	public void setProtocollo(Filtri protocollo) {
		this.protocollo = protocollo;
	}
	public void setTitolare(Filtri titolare) {
		this.titolare = titolare;
	}
	public Filtri getAttestato() {
		return attestato;
	}
	public void setAttestato(Filtri attestato) {
