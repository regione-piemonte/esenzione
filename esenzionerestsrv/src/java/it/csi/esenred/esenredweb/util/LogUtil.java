...
import it.csi.esenred.esenredweb.util.LogUtil.ToLog;

public class LogUtil {
	public static final String APPLICATION_CODE = "esenzione";
	public static final String APPLICATION_CODE_ESENRED = "esenred";
	public static final String APPLICATION_CODE_ESENPAT = "esenpat";
	...
	public LogUtil(Class<?> clazz, String application_code, String layer) {
	...
	public void tracciaRes(String methodName, Map<String, Object> res) {
		if(logger.isInfoEnabled()) {
			res.forEach((key, value) -> {
				String formattedMessage = " Key: " + key + " - Value: " + value; 
	            logger.info(String.format(pattern, className, methodName, formattedMessage));
	        });
