...
public class Checker {
	 ...
	 * cognome o altre stringhe del genere quindi non valgono i numeri e i
	 * simboli eccetto l'apice ed il trattino (es: DELL'OLIO oppure DI-GEGLIE).
	 * I caratteri accentati non sono validi.
	 * Il blank e' valido (es: EDOARDO FILIPPO). Non e' un controllo di
