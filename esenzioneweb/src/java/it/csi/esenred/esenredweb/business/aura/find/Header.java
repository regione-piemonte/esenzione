...
public class Header implements org.apache.axis2.databinding.ADBBean {
     ...
     * field for Actors
     */
    protected it.csi.esenred.esenredweb.business.aura.find.ArrayOfactorActor localActors;

    /*  This tracker boolean wil be used to detect whether the user called the set method
     *   for this attribute. It will be used to determine whether to include this field
     *   in the serialized XML
     */
    protected boolean localActorsTracker = false;
    ...
    public boolean isActorsSpecified() {
        return localActorsTracker;
    }

    /**
     * Auto generated getter method
     * @return it.csi.aura.auraws.services.central.anagrafefind.ArrayOfactorActor
     */
    public it.csi.esenred.esenredweb.business.aura.find.ArrayOfactorActor getActors() {
        return localActors;
    }
    ...
    public void setActors(
        it.csi.esenred.esenredweb.business.aura.find.ArrayOfactorActor param) {
        localActorsTracker = param != null;

        this.localActors = param;
    }
    ...
    public void serialize(final javax.xml.namespace.QName parentQName,
        ...
        if (localActorsTracker) {
            if (localActors == null) {
                throw new org.apache.axis2.databinding.ADBException(
                    "actors cannot be null!!");
            }

            localActors.serialize(new javax.xml.namespace.QName(
                    "http://AnagrafeFind.central.services.auraws.aura.csi.it",
                    "actors"), xmlWriter);
        }
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"Header".equals(type)) {
                            ...
                            return (Header) it.csi.esenred.esenredweb.business.aura.find.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
                ...
                if (reader.isStartElement() &&
                        new javax.xml.namespace.QName(
                            "http://AnagrafeFind.central.services.auraws.aura.csi.it",
                            "actors").equals(reader.getName())) {
                    object.setActors(it.csi.esenred.esenredweb.business.aura.find.ArrayOfactorActor.Factory.parse(
                            reader));
