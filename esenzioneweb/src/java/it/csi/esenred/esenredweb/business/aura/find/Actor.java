...
public class Actor implements org.apache.axis2.databinding.ADBBean {
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                    ...
                    namespacePrefix + ":Actor", xmlWriter);
            } else {
                writeAttribute("xsi",
                    "http://www.w3.org/2001/XMLSchema-instance", "type",
                    "Actor", xmlWriter);
    ...
    public static class Factory {
         ...
         */
        public static Actor parse(javax.xml.stream.XMLStreamReader reader)
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"Actor".equals(type)) {
                            ...
                            return (Actor) it.csi.esenred.esenredweb.business.aura.find.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
