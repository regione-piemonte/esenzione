...
public class EsenzioneSPraticaEsenzione implements Serializable, Comparable<EsenzioneSPraticaEsenzione> {
  ...
  //  public EsenzioneSPraticaEsenzione (EsenzioneTPraticaEsenzione etpe, boolean isDelegato) {
  //	  String codTipoUser = isDelegato ? "DELEGATO" : "BENEFICIARIO";
  //	  this.setCodRuoloOperatore(etpe.getCodRuoloOperatore());
  //	  this.setCodTipoUser(codTipoUser);
  ////	  this.setDatCreazione(new Timestamp(new Date().getTime()));//now
  //	  this.setDescNotaBeneficiario(etpe.getDescNotaBeneficiario());
  //	  this.setDescNota(etpe.getDescNote());
  //	  this.setDescNotaOperatore(etpe.getDescNotaOperatore());
  //	  this.setIdUser(new Integer(etpe.getIdUser().toString()));
  //	  this.setDatInizioValidita(etpe.getDatInizioValidita());
  //	  this.setDatFineValidita(etpe.getDatFineValidita());
  //	  //SK_CRONOLOGIA DA TABELLA DEI CONTATORI
  //	  this.setSkTipologiaStatoPratica(etpe.getSkTipologiaStatoPratica());
  //	  this.setDatModifica(etpe.getDatModifica());
  //	  this.setSkTipoMotivazione(etpe.getSkTipoMotivazione());
  //	  this.setDescNotaInterna(etpe.getDescNotaInterna());
  //	  this.setNumPratica(etpe.getNumPratica());
  //	  this.setSkDiagnosi(etpe.getSkDiagnosi());
  //	  this.setSkDistrettoSocioSanitario(etpe.getSkDistrettoSocioSanitario());
  //	  this.setSkInvaliditaTipo(etpe.getSkInvaliditaTipo());
  //	  this.setIdAzienda(etpe.getIdAzienda());
  //	  this.setCodFiscaleCittadinoBeneficiario(etpe.getCodiceFiscaleBeneficiario());
  //	  this.setSkGruppo(etpe.getSkGruppo());
  //	  this.setCodFiscaleCittadinoDelegato(etpe.getCodiceFiscaleDelegato());
  //	  this.setCodFiscaleOperatore(etpe.getCodFiscaleOperatore());
  //  }
