...
public class CsiLogAudit implements Serializable {
  ...
  public CsiLogAudit(String ipAddress, String keyOper, String oggOper, String operazione, String utente, String idRequest, String uuid, String xcodservizio) //throws Exception 
  {
	...
	public CsiLogAudit(String idApp, String ipAddress, String keyOper, String oggOper, String operazione, String utente,
			String idRequest, String uuId, String xcodServizio, String utenteBen, String utenteDel) // throws Exception
  {
    //    if (utente == null || idRequest == null || xcodServizio == null)
    //      throw new Exception("Parametri header non inseriti");
    this.idApp = idApp;
   ...
   */
	public CsiLogAudit(boolean fromAura, String idApp, String ipAddress, String keyOper, String oggOper,
			String operazione, String utente, String idRequest, String uuId, String xcodServizio, String utenteBen,
