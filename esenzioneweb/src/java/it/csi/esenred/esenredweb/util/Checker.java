...
import it.csi.esenred.esenpatweb.dto.ParametroStatoEsenzione;
...
public class Checker {
	 ...
	 * @version 0.1
	 */
	public static boolean isCodiceFiscaleCoerente(String codiceFiscale, String cognome, String nome, String sesso,
	...
	public static String getCodiceFiscale(String cognome, String nome, String sesso, Date data, String comune) {
		...
		String pattern = "[A-Z" + String.valueOf((char) 0xC0) + String.valueOf((char) 0xC8)
				+ String.valueOf((char) 0xC9) + String.valueOf((char) 0xCC) + String.valueOf((char) 0xD2)
	 ...
	 * (aderente al REGOLAMENTO (CE) N. 2560/2001) la cui sigla e' rappresentata dai
	 * primi due caratteri alfabetici del codice IBAN stesso. Nel caso in cui questi
	 * due caratteri non corrispondano ad una sigla valida il metodo restituisce
	 * zero.
	 * 
	 * @param key - sigla del paese (primi due caratteri del codice IBAN)
	 * @return int
	 * 
	 */
	 ...
	 * o altre stringhe del genere quindi non valgono i numeri ne' i simboli eccetto
	 * l'apice ed il trattino (es: DELL'OLIO oppure DI-GEGLIE). I caratteri
	 * accentati non sono validi (es: calo' va scritto calo') Il blank e' valido
	 * (es: EDOARDO FILIPPO). Non e' un controllo di obbligatorieta' quindi se non
	...
	public static boolean isTest() {
		...
		return elencoParametri.get(0).getValore().equalsIgnoreCase("TRUE");
	}

	public static boolean isMedicoCas(List<Ruolo> ruoli) {
	...
	public static boolean isDocTypeValido(String docType) {
		return Constants.DOC_TYPES.contains(docType);
	}

	public static boolean cittadinoAuraHasEsenzioni(CittadinoEsenpat cittadino) {
		return (cittadino.getEsenzioniAura() != null && cittadino.getEsenzioniAura().getInfoesenzione() != null
