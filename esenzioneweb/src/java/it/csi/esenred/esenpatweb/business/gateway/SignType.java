...
public class SignType implements java.io.Serializable {
    ...
    public static final java.lang.String _REMOTA = "REMOTA";
    public static final java.lang.String _AUTOMATICA = "AUTOMATICA";
    public static final SignType REMOTA = new SignType(_REMOTA);
    public static final SignType AUTOMATICA = new SignType(_AUTOMATICA);
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://www.csi.it/gatefire/", "signType"));
    }
    /**
