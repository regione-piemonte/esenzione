...
public class PolicyEnforcerBaseServiceServiceLocator extends org.apache.axis.client.Service implements it.csi.esenred.esenpatweb.business.iride.base.PolicyEnforcerBaseServiceService {
    ...
    public it.csi.esenred.esenpatweb.business.iride.base.PolicyEnforcerBaseService getPolicyEnforcerBase() throws javax.xml.rpc.ServiceException {
    ...
    public it.csi.esenred.esenpatweb.business.iride.base.PolicyEnforcerBaseService getPolicyEnforcerBase(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            it.csi.esenred.esenpatweb.business.iride.base.PolicyEnforcerBaseSoapBindingStub _stub = new it.csi.esenred.esenpatweb.business.iride.base.PolicyEnforcerBaseSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (it.csi.esenred.esenpatweb.business.iride.base.PolicyEnforcerBaseService.class.isAssignableFrom(serviceEndpointInterface)) {
                it.csi.esenred.esenpatweb.business.iride.base.PolicyEnforcerBaseSoapBindingStub _stub = new it.csi.esenred.esenpatweb.business.iride.base.PolicyEnforcerBaseSoapBindingStub(new java.net.URL(PolicyEnforcerBase_address), this);
                _stub.setPortName(getPolicyEnforcerBaseWSDDServiceName());
                return _stub;
            }
        }
