...
public class UserException  extends it.csi.esenred.esenpatweb.business.iride.helper.CSIException  implements java.io.Serializable {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:PolicyEnforcerHelper", "UserException"));
    }
