...
public class OpenSession  implements java.io.Serializable {
    ...
    /**
     * Gets the sessionInput value for this OpenSession.
     * 
     * @return sessionInput
     */
    ...
    /**
     * Sets the sessionInput value for this OpenSession.
     * 
     * @param sessionInput
     */
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://www.csi.it/gatefire/", "openSession"));
