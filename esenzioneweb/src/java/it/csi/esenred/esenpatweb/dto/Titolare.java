...
public class Titolare {
	...
	public Titolare(String codice_fiscale, String nome, String cognome, String sesso, String data_nascita,
	...
	public String toString() {
		return "Titolare [codice_fiscale=" + codice_fiscale + ", nome=" + nome + ", cognome=" + cognome + ", sesso="
