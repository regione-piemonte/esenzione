...
public class EsenzioneOperatoreEsenred extends EsenzioneCittadinoEsenred implements Comparable<EsenzioneOperatoreEsenred>{
	...
	public EsenzioneOperatoreEsenred(EsenredTEsenzioniReddito esenred, Cittadino beneficiario, Cittadino dichiarante) {
		this(esenred, beneficiario, dichiarante, null);
	}	

	public EsenzioneOperatoreEsenred(EsenredTEsenzioniReddito esenred, Cittadino beneficiario,  Cittadino titolare, Cittadino dichiarante) {
		...
		this.attestato = esenred.getNumProtocolloSogei()==null ? esenred.getAttestato() : esenred.getNumProtocolloSogei().toString();
	}
	
	public EsenzioneOperatoreEsenred(int numTotElementi) {
	...
	@Override
	public int compareTo(EsenzioneOperatoreEsenred o) {
