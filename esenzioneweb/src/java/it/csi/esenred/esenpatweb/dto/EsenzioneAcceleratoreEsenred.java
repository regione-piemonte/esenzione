...
public class EsenzioneAcceleratoreEsenred {
...
//	}
	...
	public EsenzioneAcceleratoreEsenred() {
	}
...
//	}
	...
	public EsenzioneAcceleratoreEsenred(EsenredTEsenzioniReddito esenred, Cittadino beneficiario, Cittadino dichiarante,Cittadino titolare) {
...
//			this.storico = "Esenzione in corso";
		...
		if (dichiarante.getIdAura()!=null && !dichiarante.getIdAura().equalsIgnoreCase("0")) {
			...
			this.creato_da.luogo_nascita = new LuogoNascita(dichiarante.getCodComuneNascita(),
		...
		if (beneficiario.getIdAura()!=null && !beneficiario.getIdAura().equalsIgnoreCase("0")) {
			...
			this.creato_per.luogo_nascita = new LuogoNascita(beneficiario.getCodComuneNascita(),
		...
		if (titolare !=null) {
			...
			this.titolare.luogo_nascita = new LuogoNascita(titolare.getCodComuneNascita(),
