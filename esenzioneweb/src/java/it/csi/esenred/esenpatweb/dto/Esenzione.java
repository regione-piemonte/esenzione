...
public class Esenzione {
	...
	private boolean dataModificabile;
	...
	public Esenzione(EsenredDTipiEsenzioniReddito eDB) {
		...
		this.dataModificabile = eDB.getDataModificabile().intValue() == 0 ? false : true;
	}
	
	 public Esenzione(EsenzioneDEsenzione ede) {
	    this.codEsenzione = ede.getCodEsenzione();
	    this.descEsenzione = ede.getDescEsenzione();
	  }
	...
	public void setDataModificabile(boolean dataModificabile) {
	...
	public String toString() {
		return "Esenzione [codEsenzione=" + codEsenzione + ", descEsenzione=" + descEsenzione + ", descMotivo="
				+ descMotivo + ",flagInseribile=" + flagInseribile +",dataModificabile=" + dataModificabile +"]";
	}
}
