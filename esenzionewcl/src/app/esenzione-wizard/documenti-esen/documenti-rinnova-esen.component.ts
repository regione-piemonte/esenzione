...
******************************************************************************/
@Component({
    selector: 'app-documenti-rinnova-esen',
    templateUrl: './documenti-rinnova-esen.component.html',
    styleUrls: ['./documenti-rinnova-esen.component.css']
})
export class DocumentiRinnovaEsenComponent implements OnInit {
...
//    documentiEsenzione: DocumentiEsenzione;
    ...
    handleFileInput(files: FileList) {
        ( document.getElementById( "messaggioesitoricercarinnovako" ).innerHTML ) = "";
